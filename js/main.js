...
const appState = {
    ...
    activeTab: 'calculator',  // calculator | learn
                ...
                <div class="max-w-7xl mx-auto px-4">
                    <div class="flex gap-1">
                        <button
                            ...
                            class="px-6 py-4 font-semibold transition-all ${appState.activeTab === 'calculator' ? 'text-purple-700 border-b-2 border-purple-700 bg-purple-50' : 'text-gray-600 hover:text-gray-900 hover:bg-gray-50'}"
                        >
                            📊 Calculator
                        </button>
                        <button
                            onclick="window.switchTab('learn')"
                            class="px-6 py-4 font-semibold transition-all ${appState.activeTab === 'learn' ? 'text-purple-700 border-b-2 border-purple-700 bg-purple-50' : 'text-gray-600 hover:text-gray-900 hover:bg-gray-50'}"
                        >
                            📚 Learn More
                        </button>
                    </div>
